...
public class SureForgetPwdSlice extends AbilitySlice implements Component.ClickedListener {
    private Button button;
    @Override
    public void onStart(Intent intent) {
        super.onStart(intent);
        super.setUIContent(ResourceTable.Layout_ability_sure_forget_pwd);
        button = (Button) findComponentById(ResourceTable.Id_sure_forget);
    ...
    public void onClick(Component component) {
        if (component.getId() == ResourceTable.Id_sure_forget){
